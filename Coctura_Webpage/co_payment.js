...
// second event listener for the page load to run a different anonymous function
window.addEventListener("load", function(){
...
// defintion of the validateYear() function
...
function luhn(idNum) {
   ...
   // retieve the even-numbered digits and double them
